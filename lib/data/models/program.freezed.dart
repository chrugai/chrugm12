...
class _$ProgramImpl implements _Program {
  ...
  @override
  String toString() {
    return 'Program(programId: $programId, userId: $userId, name: $name, description: $description, days: $days, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
